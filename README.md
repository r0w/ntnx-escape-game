...
- Book a HPOC with following characteristics : 
    ...
    - AOS 7.5
    - PC 7.5 (Need Calm 4.3 min)
    - Self-Service enabled
    - Leap Enabled
    - Flow security enabled
- In PC > Self-service, upload the **runbook**  `materials/EG-Runbook-Prerequisites.json` in the `lab` project 
- Launch it
- Upload the **blueprint** `materials/EG-Blueprint-Installation.json` in the `lab` project (WARNING : Ensure you have launched the runbook first or you'll have problems)
